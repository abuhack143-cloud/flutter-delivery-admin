import 'package:admin/controller/order/cancelOrder/cancelOrder_controller.dart';
...
class CancelOrder extends StatelessWidget {
  ...
  const CancelOrder({super.key, this.selectedOrderId});

  @override
  Widget build(BuildContext context) {
    Get.put(CancelOrderController());
    return GetBuilder<CancelOrderController>(builder: (controller) {
