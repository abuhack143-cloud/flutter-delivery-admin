...
import 'package:admin/controller/order/cityOrder/mapDelivery_controller.dart';
...
class MapDeliveryCity extends StatelessWidget {
  const MapDeliveryCity({super.key});

  @override
  Widget build(BuildContext context) {
    HomeControllerImp mapController = Get.find();
    MapDeliveryCityControllerImp controllerImp =
        Get.put(MapDeliveryCityControllerImp());
    return Scaffold(
      ...
      body: GetBuilder<MapDeliveryCityControllerImp>(builder: (controller) {
        return Stack(
          children: [
            SizedBox(
