import 'package:admin/controller/order/deliveredOrder/deliveredOrder_controller.dart';
...
class DeliveredOrder extends StatelessWidget {
  ...
  const DeliveredOrder({super.key, this.selectedOrderId});

  @override
  Widget build(BuildContext context) {
    Get.put(DeliveredOrderController());
    return GetBuilder<DeliveredOrderController>(builder: (controller) {
            ...
            itemBuilder: (context, index) {
              if (index < controller.data.length) {
                ...
                return AnimatedContainer(
                  ...
                  child: CustomStatusCardOrder(
                    from: "order_status_delivered".tr,
