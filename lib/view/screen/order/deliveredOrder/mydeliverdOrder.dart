...
import '../../../../../controller/order/deliveredOrder/mydeliveredOrder_controller.dart';

class MyDeliveredOrder extends StatelessWidget {
  const MyDeliveredOrder({super.key});

  @override
  Widget build(BuildContext context) {
    Get.put(MyDeliveredOrderController());
    return GetBuilder<MyDeliveredOrderController>(builder: (controller) {
      return Scaffold(
