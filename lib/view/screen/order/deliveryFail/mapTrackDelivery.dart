...
import 'package:admin/controller/order/deliveryFail/trackDelivery_controller.dart';
...
class MapTrackDeliveryFail extends StatelessWidget {
  const MapTrackDeliveryFail({super.key});

  @override
  Widget build(BuildContext context) {
    HomeControllerImp mapController = Get.find();

    Get.put(TrackDeliveryFailControllerImp());
    return Scaffold(
      ...
      body: GetBuilder<TrackDeliveryFailControllerImp>(builder: (controller) {
        controller.update();
        return Stack(
          children: [
            AnimatedContainer(
