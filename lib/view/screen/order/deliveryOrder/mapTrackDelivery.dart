...
import 'package:admin/controller/order/deliveryOrder/mapDelivery_controller.dart';
...
class MapTrackDelivery extends StatelessWidget {
  const MapTrackDelivery({super.key});

  @override
  Widget build(BuildContext context) {
    HomeControllerImp mapController = Get.find();
    MapTrackDeliveryControllerImp controllerImp =
        Get.put(MapTrackDeliveryControllerImp());
    return Scaffold(
      ...
      body: GetBuilder<MapTrackDeliveryControllerImp>(builder: (controller) {
        controller.update();
        return Stack(
          children: [
            SizedBox(
