...
import 'package:admin/controller/order/mapLocation_controller.dart';
...
class MapLocation extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Get.put(MapLocationControllerImp());
    return Scaffold(
      ...
      body: GetBuilder<MapLocationControllerImp>(builder: (controller) {
        return Stack(
          children: [
            AnimatedContainer(
