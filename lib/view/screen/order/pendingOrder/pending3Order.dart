...
class Pending3Order extends StatelessWidget {
  final String? selectedOrderId;
  const Pending3Order({super.key, this.selectedOrderId});

  @override
  Widget build(BuildContext context) {
    Get.put(Pending3OrderControllerImp());
    return GetBuilder<Pending3OrderControllerImp>(builder: (controller) {
                ...
                if (index < controller.data.length) {
                  ...
                  return AnimatedContainer(
                    ...
                    child: CustomCardOrder(
                      from: "order_status_waitting_delivery".tr,
