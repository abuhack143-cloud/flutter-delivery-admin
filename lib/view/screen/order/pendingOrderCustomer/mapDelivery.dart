...
import 'package:admin/controller/order/pendingOrderCustommer/mapDelivery_controller.dart';
...
class MapDeliveryCustommer extends StatelessWidget {
  const MapDeliveryCustommer({super.key});

  @override
  Widget build(BuildContext context) {
    HomeControllerImp mapController = Get.find();
    MapDeliveryCustommerControllerImp controllerImp =
        Get.put(MapDeliveryCustommerControllerImp());
    return Scaffold(
      ...
      body:
          GetBuilder<MapDeliveryCustommerControllerImp>(builder: (controller) {
        return Stack(
          children: [
            SizedBox(
