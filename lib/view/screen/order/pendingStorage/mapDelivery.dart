import 'package:admin/controller/order/storageOrder/mapDelivery_controller.dart';
...
class MapDeliveryStorage extends StatelessWidget {
  const MapDeliveryStorage({super.key});

  @override
  Widget build(BuildContext context) {
    MapDeliveryStorageControllerImp controllerImp =
        Get.put(MapDeliveryStorageControllerImp());
    return Scaffold(
      ...
      body: GetBuilder<MapDeliveryStorageControllerImp>(builder: (controller) {
        return Stack(
          children: [
            SizedBox(
