import 'package:admin/controller/other/boxSize/addBoxSize_controller.dart';
...
class AddBoxSize extends StatelessWidget {
  const AddBoxSize({super.key});

  @override
  Widget build(BuildContext context) {
    Get.put(AddBoxSizeControllerImp());
    return GetBuilder<AddBoxSizeControllerImp>(builder: (controller) {
      return Scaffold(
        appBar: AppBar(
          leading: IconButton(
