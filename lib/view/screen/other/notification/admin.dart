import 'package:admin/controller/other/notification/admin_controller.dart';
...
class AdminNotification extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Get.put(AdminNotificationControllerImp());
    return GetBuilder<AdminNotificationControllerImp>(builder: (controller) {
      return Scaffold(
        appBar: AppBar(
          leading: IconButton(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  onTap: () {
                                    Get.back(result: data.adminId.toString());
                                  },
                                  child: Text(
                                    "choose".tr,
                                    style: TextStyle(
