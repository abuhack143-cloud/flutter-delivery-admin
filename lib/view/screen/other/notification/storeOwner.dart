import 'package:admin/controller/other/notification/owner_controller.dart';
...
class OwnerNotification extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Get.put(OwnerNotificationControllerImp());
    return GetBuilder<OwnerNotificationControllerImp>(builder: (controller) {
      return Scaffold(
        appBar: AppBar(
          leading: IconButton(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  onTap: () {
                                    Get.back(result: data.ownerId.toString());
                                  },
                                  child: Text(
                                    "choose".tr,
                                    style: TextStyle(
